...
m = Mood.create(mood: "Happy", internal_external: "internal", thoughts: "holiday weekend", energy_level: 4, user_id: 2)
m = Mood.create(mood: "Sad", internal_external: "internal", thoughts: "Not going to the beach", energy_level: 2, user_id: 2)
